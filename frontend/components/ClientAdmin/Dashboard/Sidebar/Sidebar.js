...
const menuItems = [
    ...
    },
    {
        ...
        children: [
            ...
            { id: 'att-shifts', label: 'Shift Management', path: '/dashboard/attendance/shifts' },
            { id: 'att-overtime', label: 'Overtime Management', path: '/dashboard/attendance/overtime', permission: 'attendance.approve' },
    ...
    },
    {
        ...
        children: [
            ...
            { id: 'leave-encashment', label: 'Leave Encashment', translationKey: 'common.leaveEncashment', path: '/dashboard/leave?tab=encashment' },
