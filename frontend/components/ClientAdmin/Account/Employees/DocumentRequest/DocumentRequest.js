...
import {
    ...
    MoreVertical, Eye, Download, ChevronRight, Loader2
} from 'lucide-react';
import { getDocumentRequests } from '@/api/api_clientadmin';
            ...
            <div className="req-header">
                <div className="req-title-section">
                    ...
                    <div>
                        ...
                        <p>Manage employee document requests and approvals</p>
                    </div>
                </div>
                        ...
                        <table className="req-table">
                            ...
                            <tbody>
                                {filteredRequests.length > 0 ? (
                                    ...
                                    <tr>
                                        <td colSpan="6" className="text-center p-4 text-muted">No requests found</td>
                                    </tr>
                                )}
                            </tbody>
                        </table>
