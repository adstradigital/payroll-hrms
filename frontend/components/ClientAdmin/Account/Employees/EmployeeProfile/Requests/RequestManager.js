...
import { createDocumentRequest, createShiftRequest, createWorkTypeRequest, getDocumentTypes } from '@/api/api_clientadmin';
import Loader2 from 'lucide-react/dist/esm/icons/loader-2';
import './RequestManager.css';

const DEFAULT_DOC_TYPES = ['Salary Slip', 'Employment Certificate', 'Relieving Letter', 'Address Proof', 'Other'];
    ...
    React.useEffect(() => {
        const fetchTypes = async () => {
            try {
                ...
                setDocTypes(Array.from(new Set([...DEFAULT_DOC_TYPES, ...types])));
            } catch (err) {
