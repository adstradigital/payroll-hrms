...
import { BarChart, Briefcase, Calendar, Check, UserPlus, X } from 'lucide-react';
...
export default function QuickActions({ onRefresh }) {
    ...
    const loadInterviewDependencies = async () => {
        ...
        try {
            ...
            setError(formatApiError(depError, 'Failed to load candidates.'));
        } finally {
            setLoadingDeps(false);
        }
    };
    ...
    return (
        <div className="qa-wrap">
            ...
            <div className="rd-grid-actions">
                <button
                    type="button"
                    className="rd-action-btn rd-action-btn--post"
                    onClick={() => router.push('/dashboard/recruitment/job-openings')}
                >
                    <span className="rd-action-btn__icon">
                        <Briefcase size={20} />
                    </span>
                    <span>Post Job</span>
                </button>

                <button type="button" className="rd-action-btn rd-action-btn--candidate" onClick={openCandidateModal}>
                    <span className="rd-action-btn__icon">
                        <UserPlus size={20} />
                    </span>
                ...
                <button type="button" className="rd-action-btn rd-action-btn--interview" onClick={openInterviewModal}>
                    <span className="rd-action-btn__icon">
                        <Calendar size={20} />
                    </span>
                ...
                <button
                    type="button"
                    className="rd-action-btn rd-action-btn--reports"
                    onClick={() => router.push('/dashboard/recruitment/reports')}
                >
                    <span className="rd-action-btn__icon">
                        <BarChart size={20} />
                    </span>
                    ...
                    <div className="qa-modal" onClick={(event) => event.stopPropagation()}>
                        ...
                        <div className="qa-form-grid">
                            ...
                            <label className="qa-field qa-field--full">
                                ...
                                {interviewForm.candidate && (
                                    <span className="qa-hint">
                                        Auto-filled from candidate&apos;s application; change if needed.
                                    </span>
                                )}
                            </label>
