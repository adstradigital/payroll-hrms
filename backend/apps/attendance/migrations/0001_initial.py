# Generated by Django 4.2.27 on 2026-01-24 12:42
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=30, help_text="How early employees can check in"
                    ),
                ),
                (
                    "buffer_after_minutes",
                    models.PositiveIntegerField(
                        default=30, help_text="How late employees can check out"
                    ),
                ),
                (
                    "working_days",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "late_arrival_penalty_minutes",
                    models.PositiveIntegerField(
                        default=0, help_text="Deduction in minutes per late arrival"
                    ),
                ),
                (
                    "auto_mark_absent",
                ...
                (
                    ...
                    models.PositiveIntegerField(
                        default=100, help_text="Radius in meters for geo-fencing"
                    ),
                ),
                ("is_active", models.BooleanField(default=True)),
                ("effective_from", models.DateField()),
        ...
        migrations.AddIndex(
            model_name="shift",
            index=models.Index(
                fields=["company", "is_active"], name="attendance__company_38420e_idx"
            ),
        ),
        ...
        migrations.AddIndex(
            model_name="holiday",
            index=models.Index(
                fields=["company", "date"], name="attendance__company_7b4347_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="holiday",
            index=models.Index(
                fields=["date", "is_active"], name="attendance__date_3ffd05_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="holiday",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["employee", "is_active"], name="attendance__employe_6fa893_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="employeeshiftassignment",
            index=models.Index(
                fields=["shift", "is_active"], name="attendance__shift_i_101c8e_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="employeeshiftassignment",
            index=models.Index(
                ...
                name="attendance__effecti_0b0c44_idx",
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="attendance__employe_e6032d_idx",
            ),
        ),
        migrations.AlterUniqueTogether(
            name="attendancesummary",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["employee", "status"], name="attendance__employe_a97fd4_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendanceregularizationrequest",
            index=models.Index(
                fields=["status", "created_at"], name="attendance__status_379da9_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendancepolicy",
            index=models.Index(
                fields=["company", "is_active"], name="attendance__company_10aa14_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendancepolicy",
            index=models.Index(
                ...
                name="attendance__departm_8fe422_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="attendance",
            index=models.Index(
                fields=["employee", "date"], name="attendance__employe_08d913_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="attendance",
        ...
        migrations.AddIndex(
            model_name="attendance",
            index=models.Index(
                fields=["employee", "status"], name="attendance__employe_9220e1_idx"
            ),
        ),
        migrations.AlterUniqueTogether(
            name="attendance",
