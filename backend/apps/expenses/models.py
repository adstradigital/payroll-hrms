...
class ExpenseClaim(models.Model):
    ...
    receipt = models.FileField(upload_to='expenses/claims/', blank=True, null=True)
    status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending')
    current_stage = models.CharField(max_length=20, choices=STAGE_CHOICES, default='level1')
